...
| --- | --- | --- |
| [Gearbox](./Gearbox/README.md) | `require("Spoons.Gearbox").start({menu = {timeout = 5}})` | Keyboard launcher, scratchpad, nested menus, themes, navigation, and macOS power controls |
